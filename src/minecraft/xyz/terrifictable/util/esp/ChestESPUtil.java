...
public class ChestESPUtil {
    ...
    public static void blockChestESP(BlockPos blockPos, float line_width, Color color, Color color2) { // (x, y, z), 2.0f,
        ...
        GL11.glColor4d(color.getRed() / 255f, color.getGreen() / 255f, color.getBlue() / 255f, 0.15f);
        ...
        GL11.glColor4d(color2.getRed() / 255f, color2.getGreen() / 255f, color2.getBlue() / 255f, 0.5f);
